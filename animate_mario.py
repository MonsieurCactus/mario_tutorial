...
def animate_mario():
	NA = NESAnimator(framesize=(14, 20), figsize=(4, 3))

	# Set up the background frames
	bg = np.zeros((14, 18), dtype=int)
	bg_colors = np.arange(4) + np.zeros((14, 18, 4))
	...
	# little green hill 
	bg[10, 3:5] = [305, 306]
	bg[11, 2:6] = [304, 308, 294, 307]
	bg_colors[10, 3:5] = [0, 1, 4, 3]
	bg_colors[11, 2:6] = [0, 1, 4, 3]
	...
	bg[4, 12:14] = [339, 340]
	bg[5, 12:14] = [341, 342]
	bg_colors[4:6, 12:14] = [0, 6, 2, 3]


	
	# duplicate background for clean wrapping
	bg = np.hstack([bg, bg,bg])
	bg_colors = np.hstack([bg_colors, bg_colors, bg_colors])
	...
	for i in range(1):
		NA.add_frame('mario', [[16, 17], [18, 19], [20, 21], [22, 23]],
					 ctable=mario_colors, offset=(4, 10))
		NA.add_frame('mario', [[16, 17], [18, 19], [20, 21], [22, 23]],
					 ctable=mario_colors, offset=(2, 10))
		NA.add_frame('mario', [[8, 9], [10, 11], [12, 13], [14, 15]],
					 ctable=mario_colors, offset=(2, 10))
	...
	# block frames 
	block_colors = ['white', 'white' ,'#DDAA11', 'brown']
	for i in range(3):
		NA.add_frame('block', [[]],
					ctable=block_colors, offset=(0,0))
	for i in range(33):
		NA.add_frame('block', [[343, 344], [345, 346]],
					ctable=block_colors, offset=(8,12-0.5*(i+3)))

	# coin frames
	coin_colors = ['white', '#FFDEAD', 'orange', '#CC3333']
	for i in range(5):
		NA.add_frame('coin', [[]], 
					ctable=coin_colors, offset=(10,10))
	for i in range(1):
		NA.add_frame('coin', [[421,422]], 
					ctable=coin_colors, offset=(10,10))
	for i in range(1):
		NA.add_frame('coin', [[421,422],[423,424]], 
					ctable=coin_colors, offset=(10,9))
	for i in range(29):
		NA.add_frame('coin', [[]], 
					ctable=coin_colors, offset=(10,10))
	...
	NA.add_frame('troopa', [[252, 160], [161, 162], [163, 164]],
				 ctable=troopa_colors, offset=(2, 4))
	...
	NA.add_frame('goomba', [[112, 113], [114, 115]],
				 ctable=goomba_colors, offset=(2, 7))
