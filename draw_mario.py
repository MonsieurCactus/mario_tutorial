...
class NESGraphics(object):
    ...
    def __init__(self, filename='SuperMarioBros.zip', offset=2049):
        self.offset = offset
...
def draw_more_graphics():
    ...
    # tree trunk
    im[1:3, 1:3] = [[339+48-4+1, 339+48-4+2], [339+48-4+33, 339+48-4+34]]
    colors[1:3, 1:3] = [0, 7, 3, 1]

    # cliff
    im[1:3, 4:9] = [[421-64+6, 421-64+7,421-64+8,421-64+9,421-64+10], [421-64+11, 421-64+12,421-64+13,421-64+14,421-64+15]]
    colors[1:3, 4:9] = [0, 7, 8, 1]
    ...
    # dollar amounts
    im[1:3, 10:15] = [[80,252 , 246,252 ,247], [248,252 ,249, 252,250]]
    colors[1:3, 10:15] = [0,8,8,8]


    # green koopa-troopa
    im[4:7, 1:3] = [[91, 91], [252, 252], [91, 91]]
    im[5:7, 4:6] = [[256+192, 256+192], [256+193, 256+193]]
    colors[4:7, 1:6] = [0, 4, 8, 5]

    # red koopa-troopa
    im[4:7, 7:10] = [[255+64+5, 255+64+9, 255+64+10], [255+64+7, 255+32+7,255+64+11], [255+96, 255+112+9,255+112 + 11]]
    im[4:7, 11:13] = [[252, 165], [166, 167], [168, 169]]
    colors[4:7, 7:13] = [0, 6, 8, 5]
    ...
    # spiny
    im[8:10, 1:3] = [[255+160+14, -(255+160+14)], [255+160+15, -(255+160+15)]]
    im[8:10, 4:6] = [[255+64+6, 255+64+6], [255+64+8, 255+64+8]]
    im[8:10, 7:9] = [[154, 155], [156, 157]]
    colors[8:10, 1:9] = [0, 1,2,3]
    ...
    # flag
	# colors from cmap variable using CSS
	# 0 - no color
	# 1 - black
	# 2 - light gray
	# 3 - brown
    ...
    im[13:16, 1:5] = [[255+6*16+1, 255+6*16+2, 255+6*16+3,255+6*16+4], [255+6*16+5, 255+6*16+6,255+6*16+7,255+6*16+8], [255+6*16+9, 255+6*16+10,255+6*16+10,255+6*16+11]]
    colors[13:16, 1:5] = [0, 10, 8, 4]
